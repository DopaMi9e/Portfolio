    ...
    <section className="py-20 w-full">
      <div className="grid grid-cols-12 gap-4 xs:gap-6  md:gap-8 w-full">
        ...
        >
          ...
          "My journey into game development is driven by a passion for crafting immersive and interactive experiences. 
          With Unity as my spellbook and C# as my incantation, I bring virtual worlds to life. From designing engaging gameplay mechanics to optimizing performance, 
          I strive to create seamless and captivating experiences for players. My expertise spans game design, physics simulation, AI behavior, and UI/UX, 
          ensuring that every project I work on is both technically solid and visually stunning. Join me as I explore the endless possibilities of game development 
        ...
        >
          <p className="font-semibold w-full text-left text-2xl sm:text-5xl">
            4+{" "}
            <sub className="font-semibold text-base">Hackathons</sub>
          </p>
        </ItemLayout>
        ...
        <ItemLayout className={"col-span-full"}>
          <img
            className="w-full h-auto"
            src={`https://skillicons.dev/icons?i=unity,csharp,blender,cpp,photoshop,canva,github,git,linux,vscode,netlify,vercel`}          alt="AnishDogra"
            loading="lazy"
          />
        </ItemLayout>
